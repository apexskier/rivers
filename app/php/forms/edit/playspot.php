...
<h3>Edit Playspot<?php
                  ...
                  echo $name;
                  ?></h3>
<form name="add-playspot" method="post" action="/app/php/actions/edit/playspot.php">
	<input type="hidden" name="id" value="<?php echo $_GET['database_id']; ?>">
	
	<label name="playspot_name">Name</label>
	<input type="text" name="playspot_name" value="<?php echo $_GET['name']; ?>">
